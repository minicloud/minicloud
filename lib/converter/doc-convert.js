    ...
    DocConvert.prototype.__docConvertConsumer = function() {
            ...
            if (mimeType !== 'application/pdf') {
                ...
                let cmd = null
                if (osName === 'win32') {
                    cmd = '"' + this.docPath + '" --convert-to pdf:writer_pdf_Export --outdir "' + global.config.temp_path + '" "' + sourcePath + '"'
                ...
                pdfCommand.on("close", function(code, signal) {
                    ...
                    if (fileUtils.exists(tempPdfPath)) {
                        //move pdf to normal path
